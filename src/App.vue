<template>
  <header></header>
  <div id="app" class="flex justify-center overflow-x-auto items-center min-h-screen">
    <div class="flex flex-col">
      <div class="sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
            ...
            <table class="min-w-full text-center text-sm font-light">
              <thead class="border-b font-medium dark:border-neutral-500">
                <tr>
                  ...
                  <th scope="col" class="px-6 py-2">Masjid</th>
                  <th scope="col" class="px-6 py-2">Keunggulan</th>
                  <th scope="col" class="px-6 py-2">#</th>
                </tr>
              </thead>
              <tbody>
                <tr class="border-b dark:border-neutral-500" v-for="message in messages">
                  ...
                  <td class="whitespace-nowrap px-6 py-2 font-medium"> {{ message.name }}</td>
                  <td class="whitespace-nowrap px-6 py-2 font-medium">{{ message.takjil }}</td>
                  <td class="whitespace-nowrap px-6 py-2 font-medium"><button @click="deleteMessage(message.id)" class="mr-4 p-2.5 bg-red-400 rounded-xl hover:rounded-3xl hover:bg-red-700 transition-all duration-300 text-black inline-block">
              ...
              <br>
              <div class=" flex flex-col justify-center text-black text-md font-medium">
                <label for="tambah"> Tambah data</label>
              <button @click="layout = 'grid'" id="tambah" class="mr-4 p-2.5 bg-green-400 rounded-xl hover:rounded-3xl hover:bg-green-700 transition-all duration-300 text-black flex justify-center">
          ...
          <div v-if="layout == 'grid'" action="" autocomplete="off" class="" name="">
            <div class="relative z-0 mb-6">
              <input autocomplete="off"
              ref="name"
                type="text"
                id="nama"
                class="block py-2.5 px-0 w-full text-md text-black bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-[#0099ff] focus:outline-none focus:ring-0 focus:border-[#0099ff] peer"
                placeholder=" "
                name="username"
                v-model="value"
            ...
            <div class="relative z-0 mb-6">
              ...
              <label
                for="floating-username"
                class="absolute text-sm text-black dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-black peer-focus:dark:text-black peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                >Keunggulan</label
              >
            </div>
                <div class="flex justify-between">
                  <button @click="addNewMessage" id="tambah" class=" text-white mr-4 p-2.5 text-sm h-8 items-center bg-cyan-700 rounded-xl hover:rounded-3xl hover:bg-cyan-900 transition-all duration-300 flex justify-center">
                 Tambahkan </button>
...
<g id="Layer_3">
  ...
  <RouterView />
  <footer class="mx-auto py-2 text-center text-cyan-700 xl:mb-0 footer">
